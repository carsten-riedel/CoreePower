...
FunctionsToExport = 'Initialize-CorePowerLatest', 'Initialize-DevTools', 
               'Initialize-PowershellBase'
...
AliasesToExport = 'cpcp', 'cpdev', 'cppb'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'windows', 'CoreePower', 'CoreePower.Lib', 'Module', 'lib', 'beta', 'setup', 
               'NuGetPackageProvider', 'PowerShellGet', 'PackageManagement', '7-Zip', 
               'Git', 'GitHubCLI', 'NuGet', 'dotnet', 'VisualStudioCode'

        # A URL to the license for this module.
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Lib/0.0.2.25/Content/LICENSE.txt'
