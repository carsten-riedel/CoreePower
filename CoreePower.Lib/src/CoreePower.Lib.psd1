...
RequiredModules = @(@{ModuleName = 'CoreePower.Common'; ModuleVersion = '0.0.0.9'; })
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Lib/0.0.2.16/Content/LICENSE.txt'
