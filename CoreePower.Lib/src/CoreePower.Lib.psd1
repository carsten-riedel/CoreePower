...
RequiredModules = @(@{ModuleName = 'CoreePower.Common'; ModuleVersion = '0.0.0.7'; })
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Lib/0.0.2.14/Content/LICENSE.txt'
