...
RequiredModules = @(@{ModuleName = 'CoreePower.Common'; ModuleVersion = '0.0.0.12'; })
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Lib/0.0.2.19/Content/LICENSE.txt'
