...
FunctionsToExport = 'PublishModule', 'PublishModule2', 'PublishModule3', 'PublishModule4', 'UpdateModule', 'UpdateModule2', 
...
AliasesToExport = 'cppm', 'cpum', 'cppm2', 'cpcm', 'cplm', 'cpum2', 'cppm3', 'cppm4'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Module/0.0.0.57/Content/LICENSE.txt'
