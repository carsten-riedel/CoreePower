...
FunctionsToExport = 'PublishModule', 'UpdateModule', 'CreateModule', 'ListModule', 
               ...
               'Remove-ModulesPrevious', 'Remove-Modules', 'Get-ModulesInfoExtended', 
               'Get-ModulesLocal', 'Get-ModulesUpdatable', 'Update-ModulesLatest', 
               'Get-CurrentModule'
...
AliasesToExport = 'cpum', 'cppm', 'cpcm', 'cplm', 'rmpsd', 'morp', 'morm', 'moie', 'mol', 'mou', 'moul', 
               'mocu'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Module/0.0.4/Content/LICENSE.txt'
