...
function Write-Notice {
    ...
    Write-Host "Notice:" -NoNewline -ForegroundColor Black -BackgroundColor White
    Write-Host " $text" -NoNewline -ForegroundColor White -BackgroundColor Green
    Write-Host "" -ForegroundColor $currentForegroundColor -BackgroundColor $currentBackgroundColor
}
